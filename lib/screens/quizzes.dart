  ...
  final List<Map<String, dynamic>> subjects = const [
    {
      ...
      'units': [
        {
          'name': 'Unit 1', 
          'topics': ['Introduction to AI', 'Python Basics', 'Data Structures'],
          'quizzes': [
            {'name': 'Quiz 1', 'title': 'AI Fundamentals', 'questions': 10, 'duration': '15 min'},
            {'name': 'Quiz 2', 'title': 'Python Basics Assessment', 'questions': 12, 'duration': '18 min'},
            {'name': 'Quiz 3', 'title': 'Data Structures Quiz', 'questions': 8, 'duration': '12 min'},
            {'name': 'Quiz 4', 'title': 'Programming Logic', 'questions': 15, 'duration': '20 min'},
            {'name': 'Quiz 5', 'title': 'Unit 1 Final Assessment', 'questions': 20, 'duration': '30 min'}
          ]
        },
        {
          'name': 'Unit 2', 
          'topics': ['Machine Learning Fundamentals', 'Supervised Learning', 'Algorithms'],
          'quizzes': [
            {'name': 'Quiz 1', 'title': 'ML Basics', 'questions': 10, 'duration': '15 min'},
            {'name': 'Quiz 2', 'title': 'Supervised Learning', 'questions': 12, 'duration': '18 min'},
            {'name': 'Quiz 3', 'title': 'Algorithm Analysis', 'questions': 14, 'duration': '20 min'},
            {'name': 'Quiz 4', 'title': 'Model Evaluation', 'questions': 16, 'duration': '22 min'},
